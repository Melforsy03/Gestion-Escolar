...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Relations.AuxMeansProfessor", b =>
                {
                    b.Property<int>("IdAuxMeanProf")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdAuxMeanProf"));
                    ...
                    b.HasKey("IdAuxMeanProf");

                    b.HasIndex("IdAuxMean");

                    b.HasIndex("IdProf");

                    b.ToTable("AuxMeansProfessor");
                });

            modelBuilder.Entity("SchoolManagement.Domain.Relations.ClassRoomProfessor", b =>
                {
                    b.Property<int>("IdClassRoomProf")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdClassRoomProf"));
                    ...
                    b.HasKey("IdClassRoomProf");

                    b.HasIndex("IdClassRoom");

                    b.HasIndex("IdProf");

                    b.ToTable("ClassRoomProfessor");
                });
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Relations.AuxMeansProfessor", b =>
                {
                    b.HasOne("SchoolManagement.Domain.Entities.Professor", "Professors")
                        .WithMany()
                        .HasForeignKey("IdAuxMean")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolManagement.Domain.Entities.AuxiliaryMeans", "AuxiliaryMeans")
                        .WithMany()
                        .HasForeignKey("IdProf")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AuxiliaryMeans");
