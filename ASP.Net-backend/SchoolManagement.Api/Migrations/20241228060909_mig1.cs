    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessorStudentSubject", x => new { x.IdProf, x.IdStud, x.IdSub });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfessorStudentSubject_StudentSubject_IdStud_IdSub",
                        columns: x => new { x.IdStud, x.IdSub },
                        principalTable: "StudentSubject",
                        principalColumns: new[] { "IdStud", "IdSub" },
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Course_StudentIdStud",
                table: "Course",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessorStudentSubject_IdStud_IdSub",
                table: "ProfessorStudentSubject",
                columns: new[] { "IdStud", "IdSub" });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Course_Student_StudentIdStud",
                table: "Course",
                column: "StudentIdStud",
                principalTable: "Student",
                principalColumn: "IdStud");
