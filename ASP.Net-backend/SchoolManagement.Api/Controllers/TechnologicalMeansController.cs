...
namespace SchoolManagement.Api.Controllers
{
    ...
    public class TechnologicalMeansController : ControllerBase
    {
        ...
        [Route("update")]
        [Authorize(Roles = "SuperAdmin, Admin")]
        public async Task<ActionResult> UpdateTechnologicalMeans(TechnologicalMeansResponseDto technologicalMeans)
        {
        ...
        {
            var technologicalMean = await _technologicalMeansService.DeleteTechnologicalMeansByIdAsync(technologicalMeansId);
            return Ok(technologicalMean);
        }
    }
}
